...
#ifndef IGEN4_PRINT_STL_H
#define IGEN4_PRINT_STL_H
...
public:
    ...
    explicit pretty_ostream_iterator(ostream_type &stream, const char_type *delim = NULL)
...
struct is_container<boost::container::flat_set<Key, Compare, AllocatorOrContainer> > : public std::true_type {
};

// Mark map as a container
template<class Key, class T, class Compare, class AllocatorOrContainer>
struct is_container<boost::container::flat_map<Key, T, Compare, AllocatorOrContainer> > : public std::true_type {
};
...
// Delimiters for set
template<class Key, class Compare, class AllocatorOrContainer>
struct delimiters<boost::container::flat_set<Key, Compare, AllocatorOrContainer>, char> {
    static const delimiters_values<char> values;
};
...
struct print_container_helper {
    ...
    explicit print_container_helper(const T &container)
    ...
    void operator()(ostream_type &stream) const {
        ...
        std::copy(_container->begin(), _container->end(),
                  pretty_ostream_iterator<typename T::value_type, TChar, TCharTraits>(stream,
                                                                                      delimiters_type::values.delimiter));
...
std::basic_ostream<TChar, TCharTraits> &
operator<<(std::basic_ostream<TChar, TCharTraits> &stream, const std::pair<T1, T2> &value) {
